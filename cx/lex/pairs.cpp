...
PUBLIC int pairs(FILE *fp, ATYPE *array, int nrows, int ncols, int name,
                 int threshold, int numbers) {
  /* fp:output file; array:DFA transition table
   * nrows: Number of rows in array[]; ncols: Number of columns in array[]
   * name: Name used for output array; threshold: Array vs. pairs threshold
